...
// GimbalEstimatorNoOdom::GimbalEstimatorNoOdom(Config config_data, BuffEncoder* b1, BuffEncoder* b2, ICM20649* imu, CANData* data) {
//     buff_enc_yaw = b1; // sensor object definitions
//     buff_enc_pitch = b2;
//     can_data = data;
//     icm_imu = imu;
...
// FlyWheelEstimator::FlyWheelEstimator(CANData* c) {
//     can_data = c;
// }
...
// FeederEstimator::FeederEstimator(CANData* c) {
//     can_data = c;
// }
...
// SwitcherEstimator::SwitcherEstimator(Config config,CANData* c, TOFSensor* tof) {
//     can_data = c;
//     time_of_flight = tof;
...
// LocalEstimator::LocalEstimator(CANData* c) {
//     micro_estimator = true;
//     can_data = c;
// }

// void LocalEstimator::step_states(float output[NUM_MOTORS][MICRO_STATE_LEN], float curr_state[NUM_MOTORS][MICRO_STATE_LEN], int override) {
