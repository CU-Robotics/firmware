...
// NLC table, 192 bytes
constexpr uint32_t MT6835_REG_NLC_BASE =  0x013u;
constexpr uint32_t MT6835_REG_CAL_STATUS =  0x113u;
...
int main() {
    ...
    while (true) {
        ...
        if (true) {
            ...
            float motor_speed = can.get_motor_state(CAN_2, 5).speed;
            ...
            can.write_motor_torque(CAN_2, 5, output);
