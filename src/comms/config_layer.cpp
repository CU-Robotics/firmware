...
void Config::fill_data(uint8_t *bytes, uint8_t sizes[MAX_CONFIG_PACKETS], int packet_bytes){
    int config_byte_size = packet_bytes * MAX_CONFIG_PACKETS;   // total num of bytes in config packets arr
    return;
}
