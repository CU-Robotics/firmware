...
//             size_t linear_index = index / sizeof(float);
//             size_t i1 = linear_index / (NUM_STATES * 3 * 2);
//             size_t i2 = (linear_index % (NUM_STATES * 3 * 2)) / (3 * 2);
//             size_t i3 = (linear_index % (NUM_STATES * 3 * 2)) % (3 * 2);
...
//             size_t linear_index = index / sizeof(float);
//             size_t i1 = linear_index / (NUM_STATES);
//             size_t i2 = linear_index % NUM_STATES;
