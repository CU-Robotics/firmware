...
void loop() {
  ...
  lsm.read();
  Serial.print("\t\tTemperature ");
  Serial.print(lsm.get_temperature());
  Serial.println(" deg C");
  /* Display the results (acceleration is measured in m/s^2) */
  Serial.print("\t\tAccel X: ");
  Serial.print(lsm.get_accel_X());
  Serial.print(" \tY: ");
  Serial.print(lsm.get_accel_Y());
  Serial.print(" \tZ: ");
  Serial.print(lsm.get_accel_Z());
  Serial.println(" m/s^2 ");
  /* Display the results (acceleration is measured in m/s^2) */
  Serial.print("\t\tGyro X: ");
  Serial.print(lsm.get_gyro_X());
  Serial.print(" \tY: ");
  Serial.print(lsm.get_gyro_X());
  Serial.print(" \tZ: ");
  Serial.print(lsm.get_gyro_Z());
  Serial.println(" radians/s ");
  Serial.println();
  delay(100);
}