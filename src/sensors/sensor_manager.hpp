...
public:
    ...
    void init(const Cfg::RobotConfig& config_data, std::unique_ptr<RobotStateArray>* isr_safe_map);
    ...
    void initialize_sensors(std::unique_ptr<RobotStateArray>* isr_safe_map);
