 ...
 */
 ...
 #define UNITY_OUTPUT_CHAR_HEADER_DECLARATION    Serial.write(int) 
 #define UNITY_OUTPUT_FLUSH()                    Serial.flush() 
 #define UNITY_OUTPUT_FLUSH_HEADER_DECLARATION   Serial.flush(void) 
 // #define UNITY_OUTPUT_START()                    Serial.begin() 
 // #define UNITY_OUTPUT_COMPLETE()                 Serial.close() 
