...
constexpr uint16_t DR16_PACKET_SIZE = 18;
constexpr uint16_t DR16_INPUT_VALUE_COUNT = 7;

constexpr uint16_t DR16_CONTROLLER_INPUT_HIGH = 1684;
constexpr uint16_t DR16_CONTROLLER_INPUT_LOW = 364;
constexpr uint16_t DR16_CONTROLLER_INPUT_ZERO = 1024;

constexpr uint16_t DR16_CONTROLLER_SWITCH_HIGH 	= 3;
constexpr uint16_t DR16_CONTROLLER_SWITCH_LOW 	= 1;
